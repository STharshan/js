            ...
            <div className="mt-8 space-y-6">
                ...
                <section>
                    ...
                    <div className="text-white">
                        <p><strong>JS Automotive Services</strong></p>
                        <p>Email: <a href="mailto: Js.automotive1@outlook.com" className="text-[#4ab8e9] hover:underline">Js.automotive1@outlook.com</a></p>
                        <p>Phone: +44 1709 863222</p>
                        <p>Address: New Edlington, Doncaster DN12 1DJ, United Kingdom</p>
                    </div>
                    <p className="mt-2 text-white">
