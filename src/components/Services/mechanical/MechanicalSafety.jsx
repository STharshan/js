...
const MechanicalSafety = () => {
  ...
  const services = [
    ...
    {
      title: "Transmission",
      iconPath: "M15 14l-2 2-2-2m2-6h6a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6m2 0V3a2 2 0 00-2-2H9a2 2 0 00-2 2v3",
      items: [
        "Clutch replacement",
        "Gearbox repairs",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {services.map((service, idx) => (
          ...
          >
            ...
            <ul className="mt-5 space-y-2 text-gray-600 text-center md:text-left">
